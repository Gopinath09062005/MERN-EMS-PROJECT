    ...
    <div className='max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md w-96'>
        ...
        <form onSubmit={handleSubmit}>
            <div>
                ...
                <input type="text" name='dep_name' onChange={handleChange} placeholder='Enter Dep Name' className='mt-1 w-full p-2 border border-gray-300 rounded-md' required/>
            </div>
            <div className='mt-3'>
                <label htmlFor="description" className='block text-sm font-medium text-gray-700'>Description</label>
                <textarea name="description" placeholder='Description'  onChange={handleChange} className='mt-1 p-2 block w-full border border-gray-300'></textarea>
            </div>
            <button type='submit'
