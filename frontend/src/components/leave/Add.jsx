          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col space-y-4">
              ...
              <div>
                ...
                <textarea name="reason" onChange={handleChange} placeholder="Reason" className="w-full border border-gray-300 p-2"></textarea>
              </div>            
            </div>
            <button type="submit" className="w-full mt-6 bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded">Request Leave</button>
          </form>
        </div>
  )
}
