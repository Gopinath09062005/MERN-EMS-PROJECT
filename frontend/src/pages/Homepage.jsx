        ...
        <div className="max-w-4xl w-full grid md:grid-cols-2 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-700 text-base">
              <strong>Admin & Employee Roles:</strong> Separate dashboards for
              admins and employees. Admins can manage the entire system, while
              employees can access their profiles and submit requests.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            />
            <p className="text-gray-700 text-base">
              <strong>Employee & Department Management:</strong> Easily add,
              edit, and organize employee details, departments, and designations
          ...
          <div className="text-center">
            ...
            />
            <p className="text-gray-700 text-base">
              <strong>Salary & Attendance:</strong> Maintain accurate attendance
              records and calculate salaries automatically based on working
              days, leaves, and overtime.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            />
            <p className="text-gray-700 text-base">
              <strong>Leave Management:</strong> Employees can send leave
              requests directly through the portal. Admins can review and
